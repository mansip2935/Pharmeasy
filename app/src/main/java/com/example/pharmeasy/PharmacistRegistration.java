...
public class PharmacistRegistration extends AppCompatActivity {
    String[] Maharashtra = {"Mumbai","Pune","Kolhapur","Nashik"};
    String[] Gujarat = {"Ahmedabad","Surat","Surat","Rajkot"};
    String[] Karnataka = {"Bangalore","Hampi","Mysore","Rajkot"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(statee.equals("Maharashtra")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PharmacistRegistration.this,android.R.layout.simple_spinner_item,list);
        ...
        databaseReference = firebaseDatabase.getInstance().getReference("Pharmacist");
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(PharmacistRegistration.this);
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if(task.isSuccessful()){
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(PharmacistRegistration.this);
                                                            ...
                                                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(PharmacistRegistration.this,PharmacistVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(PharmacistRegistration.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
...
//
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PharmacistRegistration.this,Pharmacistloginphone.class));
                finish();
            }
        });
