...
public class Pharmacistlogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pharmacistlogin);
        try{
            ...
            Signin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(isValid()){
                        ...
                        final ProgressDialog mDialog = new ProgressDialog(Pharmacistlogin.this);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        ReusableCodeForAll.ShowAlert(Pharmacistlogin.this,"Verification Failed","You Have Not Verified Your Email");

                                    }
                                }else{
                                    mDialog.dismiss();
                                    ReusableCodeForAll.ShowAlert(Pharmacistlogin.this,"Error",task.getException().getMessage());
                                }
                            }
                        });
                    }
            ...
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Pharmacistlogin.this,PharmacistForgotPassword.class));
                    finish();
                }
            });
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Pharmacistlogin.this,Pharmacistloginphone.class));
                    finish();
                }
            });
        }catch (Exception e){
